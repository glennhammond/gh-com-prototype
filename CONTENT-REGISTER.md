...
| 7 ISQ eLearning Design System component captures | approved | Cropped through `scripts/images.mjs`; see DECISIONS.md §19. Six carry the component library's own demonstration copy, not published-course content; captions say so |
